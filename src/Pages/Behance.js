...
>
  ...
  <div className="flex space-x-4">
    <Button btnText="Start Free Trial" className="bg-white text-black px-6 py-3 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-200" />
    
    <button className="bg-gray-800 text-white px-6 py-3 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-700">
      Compare Plans
    </button>
  </div>
</div>
